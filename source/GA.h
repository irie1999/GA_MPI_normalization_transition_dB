...
constexpr int N_bit_parameter_beta_1 { 7 };
constexpr int N_bit_parameter_beta_2 { 7 };
constexpr int N_bit_parameter_h_prime_1 { 8 };
constexpr int N_bit_parameter_h_prime_2 { 10 };
...
constexpr int Number_of_Individual { 6 };  /*n個体*/
constexpr int Number_of_Generation { 1 };  /*n世代*/
